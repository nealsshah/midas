  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="grid lg:grid-cols-[280px_1fr]">
        ...
        <main className="p-6">
          {isLoading ? (
            // Dashboard in loading state: show skeleton loaders.
            <>
              <div className="mb-6">
                <Skeleton className="h-[200px] w-full bg-gray-900 animate-pulse" />
              </div>
              <div className="grid gap-4 md:grid-cols-3">
                <Skeleton className="h-[120px] bg-gray-900 animate-pulse" />
                <Skeleton className="h-[120px] bg-gray-900 animate-pulse" />
                <Skeleton className="h-[120px] bg-gray-900 animate-pulse" />
              </div>
              <div className="flex w-full gap-4 mt-6">
                <Skeleton className="h-[300px] flex-1 bg-gray-900 animate-pulse" />
                <Skeleton className="h-[300px] flex-1 bg-gray-900 animate-pulse" />
              </div>
              <div className="mt-6">
                <Skeleton className="h-[400px] w-full bg-gray-900 animate-pulse" />
              </div>
            </>
          ) : !hasData ? (
            // No data & not loading: show the uploader
            ...
            // Data is available and not loading: show the populated dashboard.
            <>
